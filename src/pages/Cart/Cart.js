...
export default function Cart() {
  ...
  return (
    <div className="pb-10 flex flex-col max-w-3xl p-6 space-y-4 dark:bg-gray-900 dark:text-gray-100 justify-center items-center ">
      <h2 className="text-2xl xl:text-3xl leading-7 xl:leading-9 text-gray-700 py-4">
        Your cart
      </h2>
      {item.map((product) => (
        <ul
        ...
        >
          <li className="flex flex-col py-2 sm:flex-row sm:justify-between">
            <div className="flex w-full space-x-2 sm:space-x-4 shadow-sm">
              <img
              ...
              <div className="flex flex-col justify-between w-full pb-4">
                <div className="flex justify-between w-full pb-2 space-x-2">
                  <div className="space-y-1">
                    <h3 className="text-lg text-gray-900 leading-snug sm:pr-8 pt-1">
                      {product.name}
                    </h3>
                  ...
                  <div className="text-right">
                    <p className="text-md  text-gray-700 pr-4 pt-1">
      ...
      <div className="mt-16 ">
        ...
        <div className="flex justify-end space-x-4">
          ...
          <button
            type="button"
            className="px-6 py-2 border rounded-md bg-indigo-200 text-indigo-500 dark:bg-violet-300 dark:text-gray-900 dark:border-violet-400 shadow-black"
          >
